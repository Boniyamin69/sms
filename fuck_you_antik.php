...
<html> 
 <head></head>
 <body>
  <img src="fuck.png" alt="Smiley face" width="200" height="200" style="vertical-align:middle;margin:10px 115px">  
  <title>YAMIN  SMS BOMBING</title> 
  ...
  <div class="container"> 
   <form method="POST"> 
    <h2>FUCKING BOMBER!</h2> 
    <h2>FUCKING SIDE</h2> 
    <br> 
    <input type="number" name="number" placeholder="ENTER NUMBER " autocomplete="off"> 
    <br>
    <br> 
